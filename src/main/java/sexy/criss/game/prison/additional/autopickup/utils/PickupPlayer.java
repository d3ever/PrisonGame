...
public class PickupPlayer {
    ...
    public PickupPlayer(Player p){
        ...
        playerData = new File(Main.getInstance().getDataFolder()+File.separator+"PlayerData"+File.separator+uuid+".yml");
    }
    ...
    public void setEnabled(boolean e) {
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                File playerFile = new File(Main.getInstance().getDataFolder()+File.separator+"PlayerData"+File.separator+uuid+".yml");
